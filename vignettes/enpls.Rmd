---
title: "A Quick Introduction to enpls"
...
vignette: >
  ...
  %\VignetteIndexEntry{A Quick Introduction to enpls}
---
...
```{r, fig.width = 8, fig.height = 8, out.width = 600, out.height = 600}
# make training set
xtrain = logd1k$x[1:500, ]
ytrain = logd1k$y[1:500]

# make two test sets
xtest = list("test.1" = logd1k$x[501:600, ],
             "test.2" = logd1k$x[601:700, ])
ytest = list("test.1" = logd1k$y[501:600],
             "test.2" = logd1k$y[601:700])

ad = enspls.ad(xtrain, ytrain, xtest, ytest,
